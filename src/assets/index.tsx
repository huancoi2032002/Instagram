...
export const MicIcon: React.FC<SvgProps> = ({ className }) => (
  <svg aria-label="Clip âm thanh" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
    ...
    <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="8.706" x2="15.104" y1="22" y2="22"></line><path d="M12 15.745a4 4 0 0 1-4-4V6a4 4 0 0 1 8 0v5.745a4 4 0 0 1-4 4Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2"></path>
  </svg>
);
...
export const AddUser: React.FC<SvgProps> = ({ className }) => (
  <svg aria-label="Tài khoản tương tự" className={className} fill="currentColor" height="16" role="img" viewBox="0 0 24 24" width="16">
    <title>Tài khoản tương tự</title>
    ...
    <line fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2" x1="8.004" x2="2.003" y1="11" y2="11"></line></svg>
);
