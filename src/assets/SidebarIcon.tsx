...
export const HomeIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Trang chủ" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
        <title>Trang chủ</title>
        <path className={className}  d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2"></path>
    </svg>
)

export const SearchIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Tìm kiếm" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
...
export const DiscoveryIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Khám phá" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
...
export const ReelIcon: React.FC<SvgProps> = ({ className }) => (
...
export const MessengerIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Messenger" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
...
export const NotificationIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Thông báo" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
...
export const PlusIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Bài viết mới" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
...
export const SettingIcon: React.FC<SvgProps> = ({ className }) => (
    <svg aria-label="Cài đặt" className={className} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
        <title>Cài đặt</title>
